...
<head>
    <title>Title</title>
    <script type="text/javascript" src="${ctx}/static/jquery/jquery-2.1.1.min.js"></script>
    <script type="text/javascript" src="${ctx}/static/jquery/jquery.superslide.2.1.1.js"></script>
    <script src="${ctx}/static/jquery-validation/1.14.0/jquery.validate.min.js" type="text/javascript"></script>
    <script src="${ctx}/static/jquery-validation/1.14.0/localization/messages_zh.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="${ctx}/static/Validform_v5.3.2/Validform_v5.3.2.js"></script>
    <script type="text/javascript" src="${ctx}/home_files/js/other.js"></script>
    <script src="${ctx}/static/layer-v2.0/layer/layer.js"></script>
    <link type="text/css" rel="stylesheet" href="${ctx}/home_files/css/style.css"/>
    <link type="text/css" rel="stylesheet" href="${ctx}/home_files/fonts/font.css"/>
</head>
<script type="text/javascript">
    ...
    var callBackTest = function(){
        $.ajax({
            type : 'POST',
            url : '${ctx}/member/validateSMSCode',
//            processData : false,
            dataType : 'text',
            data : {phone:$.trim($("#phone").val()),code:$.trim($("#code").val())},
//            data : "phone=18734857240&code=0325",
...
<input type="text" value="" id="goodsId">
<input type="button" id="orderBtn" onclick="doOrder()" width="80" value="下订单">
<a href="${ctx}/member/order/openStore" target="_blank">我要开店</a>
</body>
</html>
